...
# Network parameters #
######################
qop_ip = "192.168.1.106"  # Write the QM router IP address
cluster_name = "Cluster_RR_Lab"  # Write your cluster_name if version >= QOP220
qop_port = None  # Write the QOP port if version < QOP220

############################
# Set octave configuration #
############################
octave_port = 11241  # Must be 11xxx, where xxx are the last three digits of the Octave IP address
